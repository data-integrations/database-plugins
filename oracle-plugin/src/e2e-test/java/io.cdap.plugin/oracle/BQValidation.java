...
public class BQValidation {
  ...
  public static ResultSet getBigQueryDataAsResultSet(String targetTable) throws SQLException {
    ...
    String serviceAccount = "bq-bqmtb@cdf-athena.iam.gserviceaccount.com";
    String privateKeyPath = "/Users/vipinbhatt/Downloads/cdf-athena-48053fab02c2.json";
    String jdbcUrl = String.format("jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=%s;OAuthType=0;OAuthServiceAcctEmail=%s;OAuthPvtKeyPath=%s;", projectId, serviceAccount, privateKeyPath);
