...
public class MysqlConnectorTest extends DBSpecificConnectorBaseTest {
  ...
  public void test() throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException {
    ...
    test(new MysqlConnector(
           new MysqlConnectorConfig(host, port, username, password, JDBC_PLUGIN_NAME, connectionArguments)),
         JDBC_DRIVER_CLASS_NAME, MysqlConstants.PLUGIN_NAME);
  }
