...
public class CloudMySqlClient {
  ...
  public static Connection getCloudSqlConnection() throws ClassNotFoundException, SQLException {
    ...
    String instanceConnectionName = System.getenv("CLOUDSQL_MYSQL_CONNECTION_NAME");
    String database = PluginPropertyUtils.pluginProp("DatabaseName");
    String username = System.getenv("CLOUDSQL_MYSQL_USERNAME");
    String password = System.getenv("CLOUDSQL_MYSQL_PASSWORD");
